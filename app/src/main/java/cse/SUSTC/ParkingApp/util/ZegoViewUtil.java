package cse.SUSTC.ParkingApp.util;
...
public class ZegoViewUtil {
    ...
    static final int roomLoginingEmoji = 0x2B55;        //hollow red circle
    static final int roomLoginedEmoji = 0x1F535;        //blue circle
    static final int roomLoginFailedEmoji = 0x1F534;    //red circle
    static final int roomLogoutEmoji = 0x26AA;          //white circle
    static final int roomLogoutFailedEmoji = 0x26AA;    //red circle
    static final int roomReconnectingEmoji = 0x2B55;    //hollow red circle
    static final int roomReconnectedEmoji = 0x1F535;    //blue circle
    static final int roomReconnectFailedEmoji = 0x1F534;//red circle
    static final int roomKickoutEmoji = 0x1F534;        //red circle
